...
// Menghapus data
if ($page=='levelakademiktahunakd' AND $act=='addta'){
        $kode= $_REQUEST['cmi1'];
        $jur= $_REQUEST['cmbj1'];
        $id= $_REQUEST['cmbp1'];
 ...
 header('location:../media.php?page=levelakademiktahunakd&codd='.$kode.'&kode='.$jur.'&id='.$id);
}

elseif ($page=='levelakademiktahunakd' AND $act=='upta'){
        $kode= $_REQUEST['cmi2'];
        $jur= $_REQUEST['cmbj2'];
        $id= $_REQUEST['cmbp2'];
