...
if ($page=='akademikmahasiswa' AND $act=='addmhsw'){
  $kode= $_REQUEST['cmbj1'];
  ...
  PropinsiAsal,
  NegaraAsal)VALUES
  ('$_POST[NIM]','$_POST[username]','$pass','$_POST[Angkatan]','$_POST[nkur]','$_POST[cmi1]','$_POST[Nama]','$_POST[StatusAwal_ID]','$_POST[StatusMhsw_ID]','$_POST[cmbp1]','$_POST[cmbj1]','$_POST[pa]','$_POST[Kelamin]','$_POST[WargaNegara]','$_POST[Kebangsaan]','$_POST[TempatLahir]','$Tg','$_POST[Agama]','$_POST[StatusSipil]','$_POST[Telepon]','$_POST[Handphone]','$_POST[Alamat]','$_POST[Kota]','$_POST[RT]','$_POST[RW]','$_POST[KodePos]','$_POST[Propinsi]','$_POST[Negara]')");
   }
  header('location:../media.php?page=akademikmahasiswa&codd='.$kode);
}

elseif ($page=='akademikmahasiswa' AND $act=='updmhsw'){
  $kode= $_REQUEST['cmbj'];
 ...
 // move_uploaded_file($lokasi_file,"foto_mhs/$nama_file");
  $Tg=sprintf("%02d%02d%02d",$_POST[thntl],$_POST[blntl],$_POST[tgltl]); 
  $tglls=sprintf("%02d%02d%02d",$_POST[thntlls],$_POST[blntlls],$_POST[tgltlls]); 
  mysql_query("UPDATE mahasiswa SET username='$_POST[username]',password='$pass',
...
elseif($page=='akademikmahasiswa' AND $act=='InputModulMhs'){
        $id_level =$_REQUEST['level_ID'];
...
elseif ($page=='akademikmahasiswa' AND $act=='delmstmhsw'){
  $kode= $_REQUEST['codd'];
