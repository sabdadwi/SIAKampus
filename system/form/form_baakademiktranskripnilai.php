...
switch($_GET[PHPIdSession]){
  ...
  echo" <div id=headermodul>Index Prestasi Kumulatif</div>
        <form method=post  action='?page=levelakademiktranskrip&PHPIdSession=CariMahasiswa'>
  ...
  $no++;
  echo" <div id=headermodul>Daftar Matakuliah Yang Telah Diambilh</div>
        <form name=form1 method=post action=?page=levelakademiktranskrip&PHPIdSession=CariMahasiswa>
        <div id=groupmodul1><table id=tablemodul>    
