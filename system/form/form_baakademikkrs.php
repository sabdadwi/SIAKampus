...
function defaultbaakademikkrs(){
  ...
  echo"<div id=headermodul>Kartu Rencana Studi (KRS)</div>
        <form  method=post  action='?page=levelakademikkrs&PHPIdSession=cari'><div id=groupmodul1><table id=tablemodul>
...
function carimahasiswabaAkd(){
  ...
  $no++;
  echo"<div id=headermodul>Kartu Rencana Studi (KRS)</div>";  
  echo"<form  method=post  action='?page=levelakademikkrs&PHPIdSession=cari'>      
        ...
        <tr><td class=cc>Tahun</td>          <td class=cb><input type=text name=tahun size=5 value='$_POST[tahun]'></td>           
            ...
            <td  rowspan=6 valign=top>";
             ...
             $qry=mysql_query($sql)
             or die ();
             while($data3=mysql_fetch_array($qry)){
             echo "<img alt='galeri' src='foto_mhs/$data3[foto]' height=150/>";
             }              
  echo"</td></tr>
        <tr><td class=cc>NIM</td>                    <td class=cb><input type=text name=NIM value='$_POST[NIM]'></td></tr>
        <tr><td class=cc>Nama</td><td class=cb><strong>  $data2[nama_lengkap]</td></tr>
        <tr><td class=cc>Jurusan</td>                <td class=cb><input type=hidden name=kode_jurusan value='$data2[kode_jurusan]'>
                                <strong>$data2[kode_jurusan] - $data2[nama_jurusan]</td></tr>
        <tr><td class=cc>Program Studi</td>          <td class=cb><strong>$data2[nama_program]</td></tr>
        <tr><td class=cc>Pembimbing Akademik</td>    <td class=cb><strong>$data2[pembimbing], $data2[Gelar]</td></tr>
        </table></form>";      

  echo" <a class=s href='?page=levelakademikkrs&PHPIdSession=tambah&year_acd=$_POST[tahun]&codd_dkernlmnfso=$data2[kode_jurusan]&siaprodi_inf=$data2[Program_ID]&NIM=$_POST[NIM]'><img src=../img/printer.GIF> Tambah Matakuliah |</a> 
        ...
        <tr><th>No</th><th>Kode <br>Matakuliah</br></th><th>Nama Matakuliah</th><th>SKS</th><th>Sem</th><th>Kls</th><th>Hari</th><th>Jam <br>Mulai</br></th><th>Jam <br>Selessi</br></th><th>Dosen</th><th>Hapus</th></tr>
              ...
              $no++;
              echo "<tr>
                    <form name=form1 method=post action='?page=levelakademikkrs&PHPIdSession=hapus'>
                    ...
                    <td>$data4[kode_mtk]</td>
                    <td>$data4[nama_matakuliah]</td>
                    <td align=center>$data4[sks]</td>
                    <td align=center>$data4[semester]</td>
                    <td align=center>$data4[kelas]</td>
                    <td bgcolor=#ececec>$data4[hari]</td>
                    <td align=center bgcolor=#ececec>$data4[jam_mulai]</td>
                    <td align=center bgcolor=#ececec>$data4[jam_selesai]</td>";
              echo "<td>$data4[dosen], $data4[gelar]</td>";
                    $Tot=$Tot+$data4[sks];
              ...
              $qry=mysql_query($sql)
              or die ();
              while($data6=mysql_fetch_array($qry)){
              $no++;
              echo "<tr><th>Index Prestasi Semester</th>
                    <td bgcolor=#C0DCC0><strong>";
                    echo number_format($data6[ip],2,',','.'); 
              echo"</strong></td></tr>";
              echo "<tr><th>Maksimal SKS yg Diambil</th>
                    <td bgcolor=#C0DCC0><strong>$data6[MaxSKS]</strong></td>";
              }
...
function baakademikKrsTambah(){
  ...
  echo"</table></form>";   
  echo" 
          <form method=post action='?page=levelakademikkrs&PHPIdSession=siaadd_krsxinf'>
            <table id=tablemodul>
  ...
  echo"<div id=headermodul>Kartu Rencana Studi (KRS)</div>
        <form name=form1 method=post  action='?page=levelakademikkrs&PHPIdSession=cari'><div id=groupmodul1><table id=tablemodul>
          <tr><td class=cc>Tahun</td>    <td class=cb><input type=text name=tahun size=5></td>           
              <td rowspan=6 valign=top><input type=submit value=Cari class=tombol></td></tr>
          <tr><td class=cc>NIM</td>      <td class=cb> <input type=text name=NIM></td></tr>
          <tr><td class=cc>Nama</td>     <td class=cb> </td></tr>
